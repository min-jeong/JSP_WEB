...
<<<<<<< .mine
					         <table class="table">
									<tr id="event" style="width: 100%;"><td></td></tr>
									<tr id="contents" style="width: 100%; height: 20px;"><td></td></tr>
							</table>
=======
...
>>>>>>> .r104
	...
	<script src="/resource/vendors/fullcalendar/fullcalendar.min.js"></script>
     		                          ...
     		                          , function(data) {
     		                             	...
     		                             	try{
     		         							...
     		         							if(jsonData3.success) {
     		         								alert(date.format() + " 의 정보가 입력되었습니다.");
                    	  ...
                    	  $.post("/calendar"	
                                  ...
                                  , function(data) {
	                                  	...
	                                  	try{
	              							...
	              							alert(startDate + "의 정보가 입력되었습니다.");
		              						location.href="/goMain";
	              							}
	              							else {}
	              						}
	              						catch(e) {
	              							swal("예상치 못한 에러가 발생했습니다. 관리자에게 문의하세요.");
	              						}
                                  });
                        //Render Event
